  ...
  mounted () {
    var options = {
      ...
      moves (el, source, handle, sibling) {
        ...
        if (source.__vue__ && source.__vue__.handle) {
          handleMatch = source.__vue__.handle(handle)
        }
        return source.__vue__ && source.__vue__.moves && handleMatch
      }
    }
